        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="animate-fade-up">
            ...
            <h1 className="mt-4 text-4xl font-bold leading-tight text-slate-900 md:text-5xl lg:text-6xl">
              Sua loja vendendo mais,{" "}
              <span className="text-brand">no digital</span>
            </h1>
            <p className="mt-5 max-w-xl text-lg leading-relaxed text-slate-500">
              A {site.name} apresenta o{" "}
              <strong className="text-slate-700">Vitrine Pro</strong>: catálogo
              digital, atendimento por WhatsApp, pedidos e presença no Google —
              tudo sem precisar de equipe técnica.
            </p>
      ...
      <Section ariaLabelledby="diferenciais-title">
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-500">
              Um site comum é estático e difícil de atualizar. O Vitrine Pro
              vive junto com a sua loja.
            </p>
          </div>
        </Reveal>
          ...
          <div className="flex flex-col items-center justify-between gap-6 rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-soft md:flex-row md:p-10 md:text-left">
            <div>
              ...
              <p className="mt-2 text-slate-500">
                Cada projeto é montado sob medida, de acordo com a sua
                necessidade.
              </p>
            </div>
            <Link
